...
public class AlumnoCONS {
    ...
    public List<Alumno> obtenerInfoAlumno(String matricula){
    List<Alumno> alumno;
    alumno = entitymanager.createNamedQuery("Alumno.findByMatricula").getResultList();
    System.out.println(alumno.get(0).toString());
    return alumno;
    }
